...
const EditRecipe = () => {
  ...
  const editRecipeHandler = async (e) => {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        recipeDataToSend.append("recipePhoto", recipeData.recipePhoto);
      }
      ...
      const response = await axios.put(
        `${BASE_URL}/recipes/edit-recipe/${recipeId}`,
        recipeDataToSend,
        {
  ...
  return (
    <section className="px-[10px] md:px-[20px]">
      <form onSubmit={editRecipeHandler} className="max-w-[1170px] mx-auto">
            ...
            <div className="mb-[30px]">
              <div className="grid grid-cols-2 gap-4 items-center">
                <div className="flex items-center gap-3">
                  ...
                  {!previewURL && recipeData?.recipePhoto && (
                    <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center">
                      <img
        ...
        <div className="md:ml-auto mt-[100px] md:mt-[60px] md:w-fit">
          <button
            type="submit"
            className="py-2 px-4 bg-[#c8c8c8] rounded-md text-dark font-[600]"
          >
            {isLoading ? <Loader size={25} color="#333" /> : `Update Recipe`}
          </button>
        </div>
      </form>
    </section>
